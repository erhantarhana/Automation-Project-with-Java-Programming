...
public class AdminYöneticiKayıtSayfasıFXMLController implements Initializable {
    ...
    public static Stage yöneticiListeStage;

    public static boolean yöneticiListeSayfasıAçıkMı = false;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        kapatBtn.setOnAction(e -> {
            ...
            int index = AdminSayfasıFXMLController.sahteAdminSayfasıTP.getTabs().indexOf(AdminSayfasıFXMLController.yöneticiKayitTab);
            bölmedenSekmeyiKaldir.sekmeKaldır(AdminSayfasıFXMLController.sahteAdminSayfasıTP, index);

            AdminSayfasıFXMLController.yöneticiKayıtTabAçıkMı = false;

            if (yöneticiListeSayfasıAçıkMı)
            {
                yöneticiListeStage.close();
                yöneticiListeSayfasıAçıkMı = false;
        ...
        listeBtn.setOnAction(e -> {
            ...
            FXMLLoader loader = new FXMLLoader(Main.class.getResource("Fxml/AdminYöneticiListeSayfasıFXML.fxml"));
            try {
                loader.load();
            } catch (IOException ex) {
                ex.printStackTrace();
            ...
            yöneticiListeStage = new Stage(StageStyle.UNDECORATED);
            yöneticiListeStage.setScene(new Scene(loader.getRoot()));
            yöneticiListeStage.show();

            yöneticiListeSayfasıAçıkMı = true;
        }); 
    }   
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        Yönetici yeniYönetici = new Yönetici(maaşTxtField.getText(), adresTxtField.getText(), false, idTxtField.getText(), isimTxtField.getText(), soyİsimTxtField.getText(), kullaniciAdiTxtField.getText(), şifreTxtField.getText(), telefonTxtField.getText(), emailTxtField.getText());
                        Main.yöneticiler.add(yeniYönetici);
